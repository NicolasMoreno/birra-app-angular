      ...
      process: {
        ...
        filter: {
          ...
          config: {
            selectText: 'Proceso...',
            list: [
              { value: "MOLIENDA", title: 'Molienda' },
              { value: "MACERADO", title: 'Macerado' },
              { value: "RECIRCULADO_LAVADO", title: 'Recirculado y Lavado' },
              { value: "HERVIDO", title: 'Hervido' },
              { value: "ENFRIADO", title: 'Enfriado' },
              { value: "FERMENTACION", title: 'Fermentacion' },
              { value: "MADURADO", title: 'Madurado' },
              { value: "EMBOTELLADO", title: 'Embotellado' },
              { value: "CALIDAD", title: 'Calidad' },
            ],
          },
        }
      },
